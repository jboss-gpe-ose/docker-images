...
-----
useradd -u 1000 -g users -m -d /home/jboss jboss
-----
...
Bash command line of your new xpaas-bpmsuite container available by executing: nsenter -m -u -n -i -p -t 17997 /bin/bash
